export const FACTION_TRAITS = [
  ...
  { color: '#eab308', name: 'Yellow · Engineers', bonus: '+10% superweapon charge speed', detail: 'Prioritises weapon sites · Applies while a superweapon is charging.' },
] as const;

export const productionMultiplier = (color: string) => color === '#22c55e' ? 1.1 : 1;
export const superweaponChargeMultiplier = (color: string) => color === '#eab308' ? 1.1 : 1;
